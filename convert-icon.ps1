...
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "After creating the ICO file, run:" -ForegroundColor Yellow
Write-Host "  .\update-icon-references.ps1" -ForegroundColor White
Write-Host "to update all icon references in the project" -ForegroundColor Yellow
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
